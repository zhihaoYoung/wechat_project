  ...
  baiduAi(){
    ...
    wx.request({
      ...
      success(_res) {
        ...
        let IdCard = _res.data.words_result.签发日期.words || '';
        let idcardtime = _res.data.words_result.失效日期.words;
        wx.setStorageSync('idcradtime', idcardtime)
        ...
        success: function success(res) {
          ...
          wx.getFileSystemManager().readFile({
            ...
            success: res => { //成功的回调
                ...
                _this.getUploadUrl('data:image/png;base64,' + res.data , 'back')
            }
          })
